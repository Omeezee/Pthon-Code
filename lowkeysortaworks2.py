...
L = np.array([1.0, 0.5, 0.75,0.25], dtype=float)    #given lengths per section 
A = np.array([0.002, 0.002, 0.002,.0006], dtype=float) #given areas per section
E = np.array([200e9, 200e9, 200e9,200e9], dtype=float)  #modulus per section 
# external force positive is force put on the right side left side is negative 
Force_e_known = np.array([0.0, 0.0, 5e3, -2e3,-2e3], dtype=float) #known external forces 
n=L.size 
